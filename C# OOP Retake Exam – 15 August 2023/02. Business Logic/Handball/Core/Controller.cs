    ...
    internal class Controller : IController
    {
        ...
        public string NewPlayer(string typeName, string name)
        {
            ...
            if (players.ExistsModel(name))
            {
                ...
                return String.Format(OutputMessages.PlayerIsAlreadyAdded, name, players.GetType().Name, existingPlayer.GetType().Name);
            }
        ...
        public string LeagueStandings()
        {
            ...
            List<ITeam> sortedTeams = teams.Models.OrderByDescending(t => t.PointsEarned)
